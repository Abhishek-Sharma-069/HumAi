      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-primary">HumAi</h2>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="/symptom-checker" className="text-gray-600 hover:text-primary">AI Symptom Checker</a></li>
              <li><a href="/articles" className="text-gray-600 hover:text-primary">Preventive Health Articles</a></li>
              <li><a href="/emergency" className="text-gray-600 hover:text-primary">Emergency Helpline</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 mt-4">
              <a href="/privacy" className="block text-gray-600 hover:text-primary">Privacy Policy</a>
              <a href="/terms" className="block text-gray-600 hover:text-primary">Terms & Conditions</a>
              <p className="text-sm text-gray-500 mt-2">HumAi is not a replacement for professional medical advice.</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-gray-600">© 2025 HumAi. All rights reserved.</p>
